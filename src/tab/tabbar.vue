<template>
  <div class="digital-tabbar"
    :class="{'digital-tabbar-fix-bottom': fixBottom}"
    ref="viewArea">
    <div class="digital-tab-list"
         :style="style"
         ref="list">
      <slot></slot>
      <!-- <div class="digital-tab-active-bar"
          v-if="!fixBottom"
...
.digital-tabbar.digital-tabbar-fix-bottom {
  position: fixed;
  bottom: 0;
  left: 0;
  right: 0;
...
.digital-tabbar.digital-tabbar-fix-bottom .digital-tab-item {
...
.digital-tab-item:not(:first-child) {
  margin-left: 15px;
}
</style>
